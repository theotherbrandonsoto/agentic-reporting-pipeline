...
> **Part of a connected portfolio.** Products and issue taxonomy match the [metrics-store](https://github.com/theotherbrandonsoto/metrics-store) and [transcript-analysis](https://github.com/theotherbrandonsoto/transcript-analysis) projects, simulating a real multi-system analytics environment.
